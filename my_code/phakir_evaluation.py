...
cdict = {
    ...
    'bipolar-clamp':         [ 89, 134, 179],
    'blunt-grasper':         [128, 128, 128],
    'blunt-grasper-curved':  [200, 102, 235],
    'blunt-grasper-spec.':   [179, 102, 235],
    'clip_applicator':       [  0,   0, 255],
    'dissection-hook':       [ 80, 140,   0],
    'drainage':              [255, 100,   0],
    'grasper':               [255, 130,   0],
    'hf-coag-probe':         [255,   0, 153],
    'hook-clamp':            [  0,  80,  80],
    'needle-probe':          [204, 153, 153],
    'overholt':              [255, 200, 170],
    'palpation-probe':       [255, 102, 255],
    'pe-forceps':            [ 30, 144,   1],
    'scissor':               [255, 255,   0],
    'sponge-clamp':          [ 40, 120,  80],
    'suction-rod':           [153,   0, 204],
    'trocar-tip':            [153, 102,   0],
}
